...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--file", default="../ConformalBiomarkerTrajectories/data/data.csv")
    parser.add_argument("--folds-dir", default="../ConformalBiomarkerTrajectories/data/folds")
...
def main() -> None:
    ...
    for fold in range(args.fold_start, args.fold_start + args.n_folds):
        ...
        fold_train_ids = load_pickle_ids(folds_dir / f"fold_{fold}_train.pkl")
        test_ids = load_pickle_ids(folds_dir / f"fold_{fold}_test.pkl")
